...
namespace Paramore.Brighter.Core.Tests.CommandProcessors
{
    public class PipelinePreAndPostFiltersAsyncTests
    {
        ...
        public PipelinePreAndPostFiltersAsyncTests()
        {
            ...
            container.AddTransient<IHandleRequestsAsync<MyCommand>, MyPreAndPostDecoratedHandlerAsync>();
            container.AddTransient<IHandleRequestsAsync<MyCommand>, MyValidationHandlerAsync<MyCommand>>();
            container.AddTransient<IHandleRequestsAsync<MyCommand>, MyLoggingHandlerAsync<MyCommand>>();
